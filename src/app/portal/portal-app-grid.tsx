...
function getAppEmoji(name: string): string {
  ...
  if (n.includes("mail") || n.includes("email") || n.includes("correo")) return "📧";
  if (n.includes("slack") || n.includes("chat") || n.includes("mensaje")) return "💬";
  if (n.includes("drive") || n.includes("storage") || n.includes("archivo")) return "📁";
  if (n.includes("jira") || n.includes("project") || n.includes("proyecto")) return "🔧";
  if (n.includes("design") || n.includes("figma") || n.includes("diseño")) return "🎨";
  if (n.includes("analytic") || n.includes("report") || n.includes("reporte")) return "📊";
  if (n.includes("sales") || n.includes("venta")) return "📈";
  if (n.includes("crm")) return "🤝";
  if (n.includes("hr") || n.includes("people") || n.includes("rrhh")) return "👥";
